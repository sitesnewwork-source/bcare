...
const faqData: Record<string, { question: string; answer: string }[]> = {
  buying: [
    {
      question: "ايش التغطية اللي توفرها تري؟",
      answer: "تري توفر نوعين من التغطيات: التأمين الشامل والتأمين ضد الغير. كل نوع يوفر مستوى مختلف من الحماية يناسب احتياجاتك.",
    },
    {
